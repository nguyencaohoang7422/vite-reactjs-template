...
import { ArrowDownIcon, CheckIcon, XIcon } from '@phosphor-icons/react';
...
function ComboboxTrigger({ className, children, ...props }: Readonly<ComboboxPrimitive.Trigger.Props>) {
  return (
    <ComboboxPrimitive.Trigger
      ...
      {...props}>
      {children}
      <ArrowDownIcon data-slot="combobox-trigger-icon" className="pointer-events-none size-4 text-muted-foreground" />
    </ComboboxPrimitive.Trigger>
  );
}
...
>(({ className, ...props }, ref) => (
  <ComboboxPrimitive.Popup
    ref={ref}
    // forceMount có thể được truyền trực tiếp từ props hoặc ép ở đây
    className={cn('your-default-styles', className)}
    {...props}
  />
));
...
function ComboboxChipsInput({ className, children, ...props }: Readonly<ComboboxPrimitive.Input.Props>) {
  return (
